                        ...
                        <div class="movie-info-entity">
                            <div class="entity-poster" data-role="hover-wrap">
                                <div class="embed-responsive embed-responsive-poster">
                                    <img class="embed-responsive-item" src="./admin_panel/<?= $data_movie['img'] ?>" width="400" height="auto" style="object-fit:cover;" alt="" />
                                </div>
                                    ...
                                    <div class="gallery-entity">
                                        <div class="entity-preview" data-role="hover-wrap">
                                            <div class="embed-responsive embed-responsive-1by1">
                                                <img class="embed-responsive-item" src="./admin_panel/<?= $film['img'] ?>" height="400" style="object-fit:scale-down;" alt="" />
                                            </div>
                    ...
                    <?php foreach ($data_latest as $row) { ?>
                        <div class="movie-short-line-entity mt-2">
                            <span class="entity-preview embed-responsive embed-responsive-4by3">
                                <img class="embed-responsive-item" src="./admin_panel/<?= $row['img'] ?>" style="object-fit:scale-down " alt="" />
                            </span>
                            <div class="entity-content ">
