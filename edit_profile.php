                        ...
                        <div class="account-settings">
                            <div class="user-profile">
                                <div class="user-avatar">
                                    <img src="./admin_panel/<?= $data_user['img'] ?>" width="850" height="450" style="object-fit: cover;" class="img-thumbnail">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="text-right">
                                        <button type="submit" name="submit" class="btn-theme btn mt-3">Update</button>
