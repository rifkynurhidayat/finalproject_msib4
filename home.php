...
$data_top = select("SELECT r.* , m.id_movie, m.title, m.img, m.video , m.duration ,g.id_genre, g.genre , t.tags FROM reviewer as r 
                        ...
                        <div class="slick-slide">
                            <article class="poster-entity" data-role="hover-wrap">
                                <div class="embed-responsive embed-responsive-poster">
                                    <img class="embed-responsive-item" src="./admin_panel/<?= $movie['img'] ?>" width="400" height="400" style="object-fit:unset" alt="" />
                                </div>
        ...
        <?php foreach ($data_latest as $row) { ?>
            <article class="movie-line-entity">
                <div class="entity-poster" data-role="hover-wrap">
                    <div class="embed-responsive embed-responsive-poster">
                        <img class="embed-responsive-item" src="./admin_panel/<?= $row['img'] ?>" width="850" height="250" style="object-fit: cover;" alt="" />
                    </div>
                        ...
                        <article class="movie-line-entity">
                            <div class="entity-preview">
                                <div class="embed-responsive embed-responsive-4by3">
                                    <img class="embed-responsive-item" src="./admin_panel/<?= $comm['img'] ?>" width="400" height="400" style="object-fit:scale-down;" alt="" />
                                </div>
                                <div class="d-over">
                                    <div class="entity-play">
                    ...
                    <article class="article-tape-entity">
                        <a class="entity-preview" href="<?= $list['video'] ?>" data-magnific-popup="iframe" data-role="hover-wrap">
                            <span class="embed-responsive embed-responsive-1by1">
                                <img class="embed-responsive-item" src="./admin_panel/<?= $list['img'] ?>" height="300" width="400" style="object-fit: cover;" alt="" />
                            </span>
